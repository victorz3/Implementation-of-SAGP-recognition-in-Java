...
public class TestSuffixTree{
	...
	Arista ar_a = new Arista(raiz, a, 1, new MutableInt(1));
	Arista ar_banana$ = new Arista(raiz, hoja0, 0, new MutableInt(6));
	Arista ar_$ = new Arista(raiz, hoja1, 6, new MutableInt(6));
	Arista ar_na = new Arista(raiz, na, 2, new MutableInt(3));
	Nodo hoja2 = new Nodo(); /* Hoja de 'a#' */
	Nodo ana = new Nodo();
	Nodo hoja3 = new Nodo(); /* Hoja de 'na#' */
	Nodo hoja4 = new Nodo(); /* Hoja de 'nana#' */
	Arista ar_a$ = new Arista(a, hoja2, 6, new MutableInt(6));
	Arista ar_ana = new Arista(a, ana, 2, new MutableInt(3));
	Arista ar_na$ = new Arista(na, hoja3, 6, new MutableInt(6));
	Arista ar_nana$ = new Arista(na, hoja4, 4, new MutableInt(6));
	Nodo hoja5 = new Nodo(); /* Hoja de 'ana#' */
	Nodo hoja6 = new Nodo(); /* Hoja de 'anana#' */
	Arista ar_ana$ = new Arista(ana, hoja5, 6, new MutableInt(6));
	Arista ar_anana = new Arista(ana, hoja6, 4, new MutableInt(6));
